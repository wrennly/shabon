...
import { Modal, View, Text, TouchableOpacity, StyleSheet, Platform, TouchableWithoutFeedback, Animated } from 'react-native';
...
export function CupertinoActionSheet({ visible, onDismiss, title, message, actions }: CupertinoActionSheetProps) {
